...
1. Follow instructions in [ShunchiZhang/virtualhome@wah-fix](https://github.com/ShunchiZhang/virtualhome/tree/wah-fix) to install VirtualHome executable and Python library;
2. Switch to this repo and run `pip install -r requirements.txt`.
